...
border: 1px solid">
    <div class="clearfix">
        <?php
        $querySelect="SELECT * FROM `tblquotation` WHERE `custid`='$custid' AND shopid ='$shopidval' and qid='$proid'";
        $recordSelect=mysqli_query($conn,$querySelect);
...
border-bottom: 0px solid #5D6975;'>Quotation  Tax  <p style='margin: -27px 27px;;
font-size: 15px;
float: left;
...
color: rgb(61, 0, 255);'></p></h1> ";
    ...
    position: initial;  margin: 5px 11px;'>";
        ...
        <div id="logo1" style="float: left;width:22%;">
            <img src="<?php echo "img/".$logoImage?>" style="position: absolute;width: 166px;
    top: 42px;
    left: 13px">
        </div>
    ...
    position: initial;    margin: 5px 11px;" >
            ...
            $querySelect="SELECT * FROM `phonebook` WHERE `cid`='$custid' AND shopid ='$shopidval'";
            $recordSelect=mysqli_query($conn,$querySelect);
...
word-break: break-all;'> " . $paddress  . "</div>";?><br><br>
                ...
                <span style="float: left;margin: -45px 16px;font-weight: bold;"> GST NO:&nbsp;&nbsp;</span><?php echo "<div style='float: left;margin: -47px 123px;font-weight: bold;'>" . $pgst . "</div>";?><br><br>
...
text-align: center;'>State Code: 27</p></div>";?><br><br>
        ...
        <!--<div style="width:100%;float: left; top: 508px;position: absolute;">
            <?php
        ...
        <div style="width:100%;position: absolute;  top: 357px;height:45%;border: 1px solid;overflow: hidden;">
            <?php
...
<tbody>
                                            <tr style='font-weight: bold;font-size: 12px;background-color:#d3d5d6;height: 34px;width: 945px;float: left;'>
                                               ...
                                               <th style='color:black;;width:21px; border-top: 1px solid black;border-right: 1PX SOLID;border-left: 1PX SOLID;padding: 9px;text-align: center;float: left;'>HSN </th>
                                               ...
                                               <th style='color:black;;width:48px; border-top: 1px solid black;border-right: 1PX SOLID;padding: 9px;text-align: center;float: left;'>Amount</th>  
                                               ...
                                               <th style='color:black;;width:50px; border-top: 1px solid black;border-right: 1PX SOLID;padding: 9px;text-align: center;float: left;'>SGST %</th> 
                                               ...
                                               <th style='color:black;;width:50px;border-top: 1px solid black;border-right: 1PX SOLID;padding: 9px;text-align: center;float: left;'>Net Amt</th> 
                                               <th style='color:black;;width:40px;border-top: 1px solid black;border-right: 1PX SOLID;padding: 9px;text-align: center;float: left;'>Disc Amt</th>                         
                                               <th style='color:black;;width:96px; border-right: 1PX SOLID;border-top: 1px solid black;padding: 9px;text-align: center;float: left;'>Final Total</th>                                          
                                                                                   
                                            </tr>";

            $sql="SELECT t.* FROM `tblitem` t   WHERE t.`tid`='$proid' AND   t.`statusQT`='Q' AND t.shopid ='$shopidval'";
            $record=mysqli_query($conn,$sql);
            ...
            while($row=mysqli_fetch_array($record)) {
                ...
                echo "<td style='min-height: 453px;width: calc(100%/9);color:black;width:21px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;word-break: break-all;white-space: normal;height: auto;overflow: hidden;float: left;word-wrap: break-word;line-height: 13PX;'>".$countTot1." </td>";
                ...
                echo "<td style='min-height: 453px;width: calc(100%/9);color:black;width:48px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;word-break: break-all;white-space: normal;height: auto;overflow: hidden;float: left;word-wrap: break-word;line-height: 13PX;'>" . $row["total"] . "</td>";
                ...
                echo "<td style='min-height: 453px;width: calc(100%/9);color:black;width:50px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;word-break: break-all;white-space: normal;height: auto;overflow: hidden;float: left;word-wrap: break-word;line-height: 13PX;'>" . $row["taxname"] . "</td>";
                ...
                echo "<td style='min-height: 453px;width: calc(100%/9);color:black;width:50px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;word-break: break-all;white-space: normal;height: auto;overflow: hidden;float: left;word-wrap: break-word;line-height: 13PX;'>" . $row["taxtotal"] . "</td>";
                echo "<td style='min-height: 453px;width: calc(100%/9);color:black;width:40px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;word-break: break-all;white-space: normal;height: auto;overflow: hidden;float: left;word-wrap: break-word;line-height: 13PX;'>" . $row["discount_price"] . "</td>";
                echo "<td style='min-height: 453px;width: calc(100%/9);color:black;width:96px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;word-break: break-all;white-space: normal;height: auto;overflow: hidden;float: left;word-wrap: break-word;line-height: 13PX;'>" . $row["finaltotal"] . "</td>";
        ...
        <div style="right: 235px;width: 18%;;position: absolute;bottom: 258px;">
...
font-weight: bold;"><?php echo  $ptoword?></div>
        ...
        echo "<div style='padding: 1px 8px 3px;    bottom: 115px;
    position: absolute;
...
padding: 3px;'>Bank Name</div>
    <div style='float: left;width: 152px;
padding: 3px;'>Sant Sopankaka Sahakari Bank ltd[Shivane]</div><div style='float: left;width: 152px;
padding: 3px;'>Bank Account Number</div>
    <div style='float: left;width: 152px;
padding: 3px;'>009002100000287</div>
    <div style='float: left;width: 152px;
padding: 3px;'>IFSC Code</div><div style='float: left;width: 152px;
padding: 3px;'> ‎HDFC0CSSSBL</div></div>";*/

        ?>

        <?php
        echo "<div id='project1'>";
        echo "<div style='padding: 1px 8px 3px;    bottom: 0px;
    position: absolute;
...
margin: -57px -114px;
font-size: 15px;
font-weight: bold;"> <?php echo $phpshopname?></p>
            </br>
            </br>
            </br>
            </br>
