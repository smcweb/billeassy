...
return;
                                        ...
                                        $search_result="";
                                        $query = "SELECT tbloffer.offername,tbltax.taxName,tblcategory.catName,tblproduct.`pid`,tblproduct.`pname`,tblproduct.`price`,tblproduct.`quantity`,tblproduct.catid FROM tblproduct INNER JOIN tblcategory ON tblproduct.catid=tblcategory.catID INNER JOIN tbloffer ON tblproduct.offerid=tbloffer.offerid INNER JOIN tbltax ON tblproduct.taxid=tbltax.taxid  WHERE tblproduct.pname LIKE '%$search%'  OR tblcategory.catName LIKE '%$search%' AND tblproduct.shopId='$shopid' ORDER BY `tblproduct`.`pid` DESC";
                                    ...
                                    {
                                        $search_result="";
                                        $query = "SELECT tbloffer.offername,tbltax.taxName,tblcategory.catName,tblproduct.`pid`,tblproduct.`pname`,tblproduct.`price`,tblproduct.`quantity`,tblproduct.catid FROM tblproduct INNER JOIN tblcategory ON tblproduct.catid=tblcategory.catID INNER JOIN tbloffer ON tblproduct.offerid=tbloffer.offerid INNER JOIN tbltax ON tblproduct.taxid=tbltax.taxid AND tblproduct.shopId='$shopid' ORDER BY `tblproduct`.`pid` DESC ";
