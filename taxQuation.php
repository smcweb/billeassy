...
left: 21px;">
    ...
    position: absolute;">Details Of Bill</b></div>
            ...
            <div id="company1237"  style="text-transform: uppercase; font-size: 12px;position:initial;top: 1%;width: 114%;border-right: 1px solid black;border-top: 1px solid black;height: 40%; float:left;border-bottom: 1px solid black;
    height: 34%;">
    ...
    margin: 0px 6px;">
        ...
        <div style="width:98%;position: absolute;  top: 428px;height:16%;border: 1px solid;overflow: hidden;">
            <?php
...
<p style="width: 298px;
    ...
    position: absolute;
    bottom: 181px;"><b>Terms And Condition :-</b> <br><?php 
    ...
    font-weight: bold;
    position: absolute;
    bottom: 277px;">For <?php echo $phpshopname?></p>
            <p style="    width: 261px;
    font-size: 15px;
    font-weight: bold;
    position: absolute;
    bottom: 243px;;">
        ...
        <div style="margin: 0px 45%;position: absolute; bottom: 121px;">
