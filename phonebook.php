...
if(isset($_POST['sendm']))
{
   ...
   $sendMsgMobile= $_POST['colors'];
    if($sendMsgMobile==''){
        echo "<script>alert('Please Select Number')</script>";
                                ...
                                <div style="height: 300px; width: 100%;overflow: auto;">
                                    <table class="table">
                                        ...
                                        while( $row = mysqli_fetch_array( $search_result ))
                                        {
                                            ...
                                            ?><td >
                                            <input type="checkbox" id="checkb" class="checkbox" name="colors[]" value="<?php echo $row['phonenumber']; ?>" ></td>
