...
$insert=mysqli_query($conn,"update terms_condition set terms_condition='$terms_condition' WHERE id = $id");
if($insert)
		{
			
			echo "<script>alert('Terms & Condition update');window.location.href='allterms_condition.php'</script>";
		}
		else
		{
			echo "<script>alert('Terms & Condition not updated')</script>";
		}
 ...
 <div class="bs-example4" data-example-id="simple-responsive-table">
	...
	<td>
		<div class="form-group has-success">
			<input type="text" class="form-control1 form-control_2 input-sm" placeholder="Terms & Condition" name="terms_condition" value="<?php echo $row['terms_condition'];?>" autofocus="" required>
		</div>
	</td>
	  ...
	  <tr>
		  <td colspan="2">
			<button class="btn btn-info btn-success1 btn-block" type="submit" name="update" >Update</button>
		  </td>
	  </tr>
	  </table>
	  </div>
