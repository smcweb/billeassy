            ...
            <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="m_2"><a href="product.php"><i class="fa fa-bell-o"></i>Product<span class="label label-info">42</span></a></li>
						<li class="m_2"><a href="tax.php"><i class="fa fa-envelope-o"></i>Taxes  <span class="label label-success">42</span></a></li>
						
						<li><a href="offer.php"><i class="fa fa-comments"></i> Offer <span class="label label-warning">42</span></a></li>
						<li class="dropdown-menu-header text-center">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="takeQuotation.php"><i class="fa fa-flask nav_icon"></i>Quotation</a>
                        </li>
                         
                        <li>
                            <a href="createInvoice.php"><i class="fa fa-table nav_icon"></i>Invoice</a>
