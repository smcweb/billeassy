...
if(isset($_POST['submit']))
{
    ...
    $email=$_POST['email'];
    $pass=$_POST['password'];
    $sql = "SELECT `shopid`,`shopname`, `password`,`email`,`id`,`fid` FROM `shop` WHERE `shopid` = '$email' && `password` = '$pass' ";
                                ...
                                <table class="table">
                                    ...
                                    <tr><td><div class="form-group has-success">
                                        ...
                                        <td>	 <div class="form-group has-success">
                                                ...
                                                <input type="text" class="form-control1 form-control_2 input-sm" placeholder="GST number" name="gst" autofocus="" required>
                                    ...
                                    <tr> <td><div class="form-group has-success">
                                        ...
                                        <td> <div class="form-group has-success">
                                                <input type="text" class="form-control1 form-control_2 input-sm" placeholder="Address" name="address" autofocus="" required>
                                            </div></td></tr>
