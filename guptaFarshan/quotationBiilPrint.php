...
$sql="SELECT * FROM `tblquotation` WHERE `custid`='$custid'";
...
border: 1px solid">
    <div class="clearfix">
        <?php
        $querySelect="SELECT * FROM `tblquotation` WHERE `custid`='$custid'";
        $recordSelect=mysqli_query($conn,$querySelect);
...
word-break: break-all;'> " . $paddress  . "</div>";?><br><br>
    ...
    line-height: 34px;
    text-align: center;
    font-weight: bold;'>State Code: " . $pstateCode . "</p>
</div>";?><br><br>
            </div>
...
text-align: center;'>State Code: 27</p></div>";?><br><br>
        ...
        <div style="width:100%;position: absolute;  top: 348px;height:45%; overflow: hidden;border: 1px solid">
            <?php
...
<tbody>
                                            <tr style='background-color:#d3d5d6;height: 34px;width: 953px;float: left;'>
                                               <th style='color:black;;width:28px; border: 1px solid black;padding: 9px;text-align: center;float: left;'>SrNo.</th>
                                               <th style='color:black;;width:161px; border: 1px solid black;padding: 9px;text-align: center;float: left;'>Item Name</th>
                                                 <th style='color:black;;width:45px; border: 1px solid black;padding: 9px;text-align: center;float: left;'>HSN No.</th>                                          
                                               <th style='color:black;;width: 40px; border: 1px solid black;padding: 9px;text-align: center;float: left;'>UDM</th>
                                               ...
                                               <th style='color:black;;width:53px; border: 1px solid black;padding: 9px;text-align: center;float: left;'>Total</th>  
                                                <th style='color:black;;width:76px; border: 1px solid black;padding: 9px;text-align: center;float: left;'> Offer %</th> 
                                               <th style='color:black;;width:87px; border: 1px solid black;padding: 9px;text-align: center;float: left;'>Discount Price</th>                                          
                                                                                       
                                               <th style='color:black;width: 79px; border: 1px solid black;padding: 9px;text-align: center;float: left;'>Final Total</th>                                          
                                            </tr>";

            $sql="SELECT t.*, tt.`offerPercent` FROM `tblitem` t JOIN tbloffer tt ON t.`oid`=tt.`offerid`  WHERE t.`tid`='$proid' AND t.`statusQT`='Q'";
            $record=mysqli_query($conn,$sql);
            ...
            while($row=mysqli_fetch_array($record)) {
                ...
                echo "<td style='min-height: 564px;width: calc(100%/10);border-bottom: 1px solid black;color:black;width:29px;border-right: 1px solid black;padding: 9px;text-align: center;float: left; word-wrap:break-word; height: 60%;'>" . $counter . "</td>";
                echo "<td style='min-height: 564px;width: calc(100%/10);border-bottom: 1px solid black;color:black;width:162px;border-right: 1px solid black;padding: 9px;text-align: center;float: left; word-wrap:break-word; height: 60%;'>" . $row["pname"] . "</td>";
                echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:46px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'></td>";
                echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:41px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'></td>";
                echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:93px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'>" . $row["quantity"] . "</td>";
                echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:91px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'>" . $row["unitprice"] . "</td>";
                echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:54px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'>" . $row["total"] . "</td>";
                echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:77px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'>" . $row["offerPercent"] . "</td>";
                echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:88px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'>" . $row["discount_price"] . "</td>";

                echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:80px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'>" . $row["taxtotal"] . "</td>";
        ...
        bottom: 268px;">
            <table  class='table' style='border: 1px solid black;border-collapse: collapse;position: absolute;height: 100%;'>
                ...
                <tr style='background-color:white;height: 31px;position: relative;float: left;    border: 1px solid black;border-bottom: 0px solid #C1CED9;'>
                    ...
                    <th colspan='1' style='padding: 5px 22px;color: black;white-space: nowrap;font-weight: normal;width: 287px;height: 26px;border-right: 1px solid black;'>SubTotal</th>
                    <th colspan='1' style='padding: 5px 22px;color: black;white-space: nowrap;font-weight: normal;width: 37px;'> <?php echo $btotal?> </th>
                </tr>
                <tr style='background-color:white;height: 31px;position: relative;float: left;    border: 1px solid black;border-bottom: 0px solid #C1CED9;'>
...
font-weight: bold;"><?php echo  $ptoword?></div>
        ...
        echo "<div style='    padding: 1px 8px 3px;
           bottom: 34px;
    position: absolute;
    border: 1px solid #151514;
    width: 45%;
    min-height: 118px;height: auto'><div style='float: left;
margin: 0px 123px;
padding: 5px;
font-size: 15px;
...
padding: 3px;'>Bank Name</div>
    <div style='float: left;width: 152px;
padding: 3px;'>Kotak Mahindra Bank[Sinhagad Road]</div><div style='float: left;width: 152px;
padding: 3px;'>Bank Account Number</div>
    <div style='float: left;width: 152px;
padding: 3px;'>2811586452</div>
    <div style='float: left;width: 152px;
padding: 3px;'>IFSC Code</div><div style='float: left;width: 152px;
padding: 3px;'> KKBK0001764</div>
<p style='border-top: 1px solid;
    ...
    line-height: 26px;
    font-weight: bold;'>Terms & Conditions</p>
<div style='    width: 434px;
    padding: 0px;
    word-wrap: break-word;float: left;'> $pBillTerms</div></div>";
