...
border-bottom: 0px solid #5D6975;'>Bill of Supply <p style='margin: -27px 27px;;
font-size: 15px;
float: left;
...
text-align: center;'>State Code: 27</p></div>";?><br><br>
        ...
        <div style="width:100%;float: left;     top: 349px;position: absolute;">
            <?php
            echo "<table id='tot-header'  class='table' style='border: 1px solid black;border-collapse: collapse;'>
 <thead>
                                            <tr style='background-color:#d3d5d6;word-wrap:break-word; height: 60%;'>
            ...
            echo"<tbody>";
            echo"<tr word-wrap:break-word; height: 60%;>";
        ...
        <div style="width:100%;position: absolute;  top: 409px;height:50%; overflow: hidden;border: 1px solid">
            <?php
...
$zen=1;
            while($row=mysqli_fetch_array($record)) {
                ...
                echo "<td style='min-height: 564px;width: calc(100%/10);border-bottom: 1px solid black;color:black;width:167px;border-right: 1px solid black;padding: 9px;text-align: center;float: left; word-wrap:break-word; height: 60%;'>" . $row["pname"] . "</td>";
				echo "<td style='min-height: 564px;width: calc(100%/9);border-bottom: 1px solid black;color:black;width:50px;border-right: 1px solid black;padding: 9px;text-align: center;float: left;'></td>";
...
padding: 3px;'>Bank Name</div>
    <div style='float: left;width: 152px;
padding: 3px;'>Kotak Mahindra Bank[Shinghgad Road ]</div><div style='float: left;width: 152px;
