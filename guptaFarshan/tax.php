...
if(isset($_POST['Submit']))
{
    ...
    else
    {
        ...
        $sql = "insert into tbltax(taxName,taxPercent,shopid)values('$Taxname','$Taxpercent','$shopid')";
...
if(isset($_POST['update']))
{
    ...
    else
    {
        ...
        $sql1 ="UPDATE tbltax SET taxPercent='$Taxpercent',taxName='$Taxname'  WHERE taxid='$Tid' AND shopid='$shopid'";
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST">
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control1" id="tname" name="tname">
                            </div>
                            <div class="form-group ">
                                <label style="width: 90%;color:black" for="inputWarning1">Tax Percent</label>
                            ...
                            <div style="height: 300px; width: 100%;overflow: auto;">
							   ...
							   <button class="btn btn-success" type="submit" name="submit"><i class="fa fa-search"></i></button></span>
                                    ...
                                    <tr >
                                        ...
                                        <th style="color:black;text-align:center">Tax Percent</th>
