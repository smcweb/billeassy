...
if(isset($_POST['sub']))
{
    ...
    $Productprice=$_REQUEST['addprice'];
    ...
    else
    {
        ...
        $sql = "INSERT INTO `tblproduct`(`pname`, `price`, `quantity`, `taxid`, `catid`, `offerid`,shopid) VALUES ('$Productname','$Productprice','$Productquantity','$tax','$catid','$offer','$shopid');";
...
if(isset($_POST['update']))
{
    ...
    else
    {
        ...
        $sql1 ="UPDATE `tblproduct` SET `pname`='$Productname',`price`='$Productprice',`quantity`='$Productquantity',`taxid`='$tax',`catid`='$catid',`offerid`='$offer' WHERE `pid`='$pid' and shopid='$shopid'";
        ...
        function rowshow(id)
        {
            ...
            $.ajax({
                ...
                success: function (response) {
					...
					// $('#tax').val(response[0].taxid)
					//$('#offer').val(response[0].offerid)
...
?>
        ...
        ?>
                                    ...
                                    <input type="text" placeholder="" class="form-control1" style="margin-left:;color:black"  id="productid" name="pid" value="<?php echo $max;  ?>">
                                    ...
                                    <select class="form-control1" name="tax" id="tax">
                                    ...
                                    <label style="width: 90%;color:black" for="inputSuccess1">Product Price</label>
                                    <input type="text" placeholder="" class="form-control1" style="margin-left:;width: 90%;color:black" id="addprice" name="addprice">
