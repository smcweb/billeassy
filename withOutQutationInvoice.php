...
border-bottom: 0px solid #5D6975;'>Quotation <p style='margin: -27px 27px;;
font-size: 15px;
float: left;
...
color: rgb(61, 0, 255);'></p></h1> ";
    ...
    height: 116px;">
        ...
        <div id="company1" style="border: 1px solid black;float: left;width: 56%;height:20%;position: initial;top: -5px;margin:-4px 11px;">
		 ...
		 <div style='font-size: 15px;font-weight: bold;float: left;width: 111%;height: 10px;padding: 6px;'><b style="margin: 8px 1px;
    position: absolute;">Subject :-<?php echo $subject; ?></b></div>
	
        <div id="company123" style="width: 38%;height: 34%;position: absolute;top: 168px;float: right; margin-left: 55%;text-align: left;">
            <div style='font-size: 15px;font-weight: bold;float: left;width: 111%;height:30px;margin: 9px 1px;  padding: 6px;border-right: 0px solid black;'><b style="    margin: 21px 1px;
    position: absolute;">Details Of Bill</b></div>
            <div id="company1237"  style="text-transform: uppercase; font-size: 12px;position:initial;top: 1%;width: 114%;border-right: 1px solid black;border-top: 1px solid black;border-bottom: 1px solid black;
    height: 35%;float:left;">
        ...
        $sql="SELECT * FROM `tblquotation` WHERE `custid`='$custid' AND shopid ='$shopidvalbn' AND qid='$proid'";
        $record=mysqli_query($conn,$sql);
    ...
    margin: 0px 6px;">
         ...
         <thead>
           ...
           /* echo"<tr>";
            ...
            echo "<td style='color:black;border: 1px solid black;padding: 9px;text-align: center;'>" . 0 . "</td>";
            echo "<td style='color:black;border: 1px solid black;padding: 9px;text-align: center;'>" . 0 . "</td>";
        ...
        <div style="width:98%;position: absolute;  top: 439px;height:21%; overflow: hidden;border: 1px solid">
            <?php
...
<tbody>
            ...
            $sql="SELECT t.*, tt.`offerPercent`FROM `tblitem` t JOIN tbloffer tt ON t.`oid`=tt.`offerid`  WHERE t.`tid`='$proid' AND t.`statusQT`='Q' AND t.shopid ='$shopidvalbn'";
...
font-weight: bold;"><?php echo  $ptoword?></div>
    ...
    padding: 3px;'>$pBankName</div></div>*/
        ...
        ?>
		 <div style="margin: 47px 4%;position: absolute;bottom: -40px; width: 150px;">
<p style="width: 298px;
    font-size: 15px;
    
    position: absolute;
    bottom: 181px;"><b>Terms And Condition :-</b> <?php 
	   ...
	   while($row=mysqli_fetch_array($query)) {
		...
		?>
	<?php echo $terms_condition; ?><?php }?> </p>
           
        </div>
        <div style="margin: 230px  81%;
		position: absolute;
		bottom: -24px;
		width: 150px;">
            <b style='    float: left;
