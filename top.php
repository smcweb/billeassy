<head>
<style>
#horizontalmenu ul { padding:1px; margin:1px; list-style:none; } #horizontalmenu li { float:left; position:relative; padding-right:0px;    padding-top: 6px; display:block; } #horizontalmenu li ul { display:none; position:absolute; } #horizontalmenu li:hover ul{ display:block;background: #f0dcf7;height:auto; width:12em; COLOR:BLACK } #horizontalmenu li ul li{ clear:both; border-style:none;}
</style>
</head>
<div class="graphs">
     	<div class="col_3">
         ...
         <a href=""> <i class="pull-left fa fa-thumbs-up icon-rounded"></i></a>BILLING<br>
                   <!-- <div  id="horizontalmenu">-->
                        <span> <a href="makeBill.php" style="color: black; text-decoration: none;">Without Tax </a><br></span>
                        <span>  <a href="withTaxMakeBill.php" style="color: black; text-decoration: none;">With Tax </a><br></span>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
