    ...
    float: right;    width: 12%;"><i class="fa fa-search"></i></button></div>								
					...
					$sr=0;
                            while($row=mysqli_fetch_array($query,MYSQLI_ASSOC))
                            {
								...
								<td  style='color:black'> <center><?php echo $sr; ?></center></td>
                                <td style='color:black'><center><?php echo $row['tdate']; ?></center></td>
                                <td style='color:black'><center><?php echo $row['total_sales'];?></center></td>
