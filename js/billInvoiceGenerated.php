...
<tbody>
            ...
            $sql="SELECT t.*, tt.`offerPercent`FROM `tblitem` t JOIN tbloffer tt ON t.`oid`=tt.`offerid`  WHERE t.`tid`='$proid' AND t.`statusQT`='T' AND t.shopid ='$shopidval'";
            $record=mysqli_query($conn,$sql);
...
font-weight: bold;"><?php echo  $ptoword?></div>
    ...
    width: 45%;
    min-height: 118px;height: auto'>Terms & Conditions</p>
