...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design"/>
    ...
    <!-- Bootstrap Core CSS -->
    <script data-require="sweet-alert@*" data-semver="0.4.2" src="sweet-alert.min.js"></script>
    <link data-require="sweet-alert@*" data-semver="0.4.2" rel="stylesheet" href="sweet-alert.min.css" />
                ...
                req.onreadystatechange = function () {
                    if (req.readyState == 4) {
                        if (req.status == 200) {
                            ...
                            document.getElementById('proName-id-1').innerHTML = req.responseText;

                        }
                        else {
                            alert("Problem while using XMLHTTP:<br>" + req.statusText);
                        }
                    }
                }
...
//$finalamt= $gtxt_balance+$txt_gamt-$nremaining;
 ...
 VALUES ('$cid','$billNo','$invoiceDate','$txt_samt1','$txt_disc','$txt_gamt1','$txt_paiding','$txt_words','$custStCode','$txt_remeingBal','$shopidBn','$fid','$txt_modeOfPayment','$txt_cashid','T','withoutTax')";
    $record = mysqli_query($conn, $query);
...
VALUES ('$txt_addProName[$key]','$txt_MRP[$key]','$txt_qty[$key]','$txt_totalAmt[$key]','$txt_finalTotalAmt[$key]','$billNo','$shopidBn','$fid','$txt_offeridval[$key]','$last_row','T','$txt_addHsncode[$key]','$txt_discountPrice[$key]')";
    $record = mysqli_query($conn, $query);
    ...
    setTimeout(function() {
        swal({
            ...
            window.location = 'withOutTaxInvioce.php?custid=$cdid&proId=$pid';
        });
    }, 500);
</script>";
        /*echo '<script>sweetAlert("Good job!", "Wait For Print !", "success")</script>';*/
